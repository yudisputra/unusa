...
<body id="page-top">
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 id="homeHeading">Selamat Datang</h1>
                <h1 id="homeHeading">Himpunan Mahasiswa Manajemen UNUSA</h1>
                <hr>
                <!-- <p>Start Bootstrap can help you build better websites using the Bootstrap CSS framework! Just download your template and start going, no strings attached!</p> -->
                <a href="<?php echo base_url()?>home/search" class="btn btn-primary btn-xl page-scroll">PENGUMUMAN</a>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h2 class="section-heading">HIMA MANAJEMEN UNUSA!</h2>
                    <hr class="light">
                    <p class="text-faded">Start Bootstrap has everything you need to get your new website up and running in no time! All of the templates and themes on Start Bootstrap are open source, free to download, and easy to use. No strings attached!</p>
                    <!-- <a href="#services" class="page-scroll btn btn-default btn-xl sr-button">Get!</a> -->
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="services">
        <div class="container">
            <div class="row">
                <div class="col-lg-16 text-center">
                    <h2 class="section-heading">OUR DIVISI</h2>
                    <hr class="primary">
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-16 text-center">
